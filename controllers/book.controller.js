...
const { response } = require("../routes/member.route")
...
exports.updateBook = async (request, response) => {
    ...
    upload(request, response, async error => {
        ...
        */
        ...
        // execute update databased on defined id book
        bookModel.update(book, { where: { id: id } })
            .then(result => {
                // if update's procces sicces
                return response.json({
                    succes: true,
...
exports.deleteBook = async (request, response) => {
    ...
    bookModel.destroy({ where: { id: id } })
        .then(result => {
            // if update's procces success
            return response.json({
                succes: true,
                message: `Data book has been selected`
            })
        })
        .catch(error => {
            return response.json({
